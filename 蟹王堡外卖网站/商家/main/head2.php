            ...
            <div>
                <table>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM order_dishes WHERE dish_Merchantname='{$_SESSION['Restaurant']}' ORDER BY order_time";
                        //echo $sql;
                        ...
                        ?>
                            <tr class="tr_line2">
                                ...
                                <td>
                                    <P>菜品编号：<?php echo  $row['dish_num']; ?></P>
                                    <P> 菜品名：<?php echo  $row['dish_name']; ?></P>
                                    <P> 数量：<?php echo  $row['countt']; ?></P>

                                </td>
                                <td> <?php echo $row['zongjia'];        ?> </td>
                                <td> <?php echo $row['order_time'];      ?> </td>
                                <td> <?php echo $row['note'];              ?> </td>
                                <td><a href="cancell.php?id=<?php echo $row['id']; ?>">取消</a> </td>
                            </tr>
                        <?php
                        }
                        ?>

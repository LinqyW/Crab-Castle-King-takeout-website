...
<body style="width: 100%; position: relative;">
  ...
  <div class="contain">
    ...
    <?php
			...
			$sql = "INSERT INTO dishes (dID,dname, ddiscribe, dprice,Merchantname,Restaurant) VALUES ('{$_POST['dID']}','{$_POST['dname']}', '{$_POST['ddiscribe']}', '{$_POST['dprice']}','{$_SESSION['username']}','{$_SESSION['Restaurant']}')";
			 echo $sql;
